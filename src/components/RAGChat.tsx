  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "welcome",
      sender: "assistant",
      text: `Hello! I am Vantly AI's Document RAG Assistant powered by FastAPI, pypdf, and Gemini embeddings. Ask me any granular question about **${fileName}** for ${companyName}, and I will retrieve exact page citations and relevant vector snippets.`,
